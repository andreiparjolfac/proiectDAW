...
if (empty($_POST['contact_subject'])) {
    redirectWithError("Please enter your Subject in the form.");
}

if (empty($_POST['contact_category'])) {
    redirectWithError("Please enter your category in the form.");
}
...
if (strlen($_POST['contact_message']) < 10) {
...
try {
    ...
    // Content
    $mail->Subject = "[Contact Form] [".$_POST['contact_category']."]".$_POST['contact_subject'];
    $mail->Body    = <<<EOT
