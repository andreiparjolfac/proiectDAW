...
define('CONTACTFORM_FROM_ADDRESS', 'parjoldaw@gmail.com');
define('CONTACTFORM_FROM_NAME', 'Proiect DAW Ecommerce');
...
define('CONTACTFORM_TO_ADDRESS', 'andrei.parjol@s.unibuc.ro');
define('CONTACTFORM_TO_NAME', 'Andrei Parjol');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'parjoldaw@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'kkqqtxkscbcmnnja');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6LeQg7sjAAAAAAJI4zJXPIBmGDsOXT5KVDzFbVSU');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6LeQg7sjAAAAAJk4m0K54jt-v0wdnIDvMVaFqZkG');
